...
a persistence unit "demooPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "demoo/pom.xml":
...
artifact ("demoo.war") is already built. You can build
